...
<head>
    <script>
        function fnam()
        {
            var fnam=/^[Aa-zA-Z]{4,15}$/;
            if(document.f1.t1.value.search(fnam)==-1)
            {
                alert("enter correct first name with more than three letters");
        ...
        function vali()
        {
            var nam=/^[Aa-zA-Z]{4,15}$/;
            var email=/^[a-zA-Z0-9-_\.]+@[a-zA-Z]+\.[a-zA-Z]{2,3}$/;
            var pass=/^[a-zA-Z0-9-_]{6,16}$/;
            var phn=/^[0-9]{9,14}$/;
            var add=/^[Aa-zA-Z0-9 ]{10,150}$/;
            var city=/^[Aa-zA-Z]{5,30}$/;
...
<div><br/><center><h2><font face="Lucida Handwriting" size="+1" color="#00CCFF">Register Here</font></h2></center></div>
<div>
