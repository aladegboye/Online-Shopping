...
<table width="366" border="0" align="center">
  ...
  <tr>
    ...
    <td><input name="m3" type="text" id="m3" onChange="return lnam()" readonly="readonly" value="GBP<?php echo $mat['price'];?>">  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><label>
      <select name="sel2" id="sel2">
        ...
        <option value="TSB" selected>BOS</option>
        <option value="ICICI">TSB</option>
